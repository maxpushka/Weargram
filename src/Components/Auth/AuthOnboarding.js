...
export default class AuthOnboarding extends Component {
  constructor(props) {
    super(props);
    console.log('at LoginOnboarding', this.props.path);
  }
  ...
  componentDidMount() {
    ...
    window.addEventListener('popstate', this.onGoingBack);
  }

  componentWillUnmount() {
    console.log('removing back button prevention event');
    window.removeEventListener('popstate', this.onGoingBack);
  }
        ...
        <div className="ui-page ui-page-active">
          ...
          <div className="ui-content flexBody">
            <div className="flex" style={{width: '120px'}}>
              <Link to={`${this.props.path}/phone`} target="_self"
            ...
            <div className="flex" style={{width: '120px'}}>
              <Link to={`${this.props.path}/qr`} target="_self"
                    className="ui-btn ui-btn-icon ui-btn-circle btn-large"
                    style={{
                      backgroundImage: `url(${process.env.PUBLIC_URL +
